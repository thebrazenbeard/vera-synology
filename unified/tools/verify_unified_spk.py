...
def main():
 ...
 if 'version="0.2.0-0007"' not in o["INFO"].decode() or "veramesh_supervisor.py" not in o["conf/systemd/pkguser-veramesh.service"].decode():raise ValueError("outer contract")
